/*!
 * materiaalize css dynamic rtl | ltr v1.0.0 (https://github.com/mustafaemadeldeen/materializecss-dynamic)
*/
/*!
...
var _documentDirection = (document.documentElement.getAttribute('dir') === null || document.documentElement.getAttribute('dir') === undefined) ? 'ltr' : document.documentElement.getAttribute('dir');

var _documentDirectionName = (_documentDirection === 'ltr') ? 'left' : 'right';
  ...
  var Materialbox = function (_Component4) {
    ...
    _createClass(Materialbox, [{
      ...
      value: function _animateImageOut() {
        ...
        if (_documentDirectionName === 'left') {
          animOptions.left = 0;
        } else if (_documentDirectionName === 'right') {
          animOptions.right = 0;
        }
  ...
  var Chips = function (_Component12) {
    ...
    _createClass(Chips, [{
      ...
      value: function _renderChip(chip) {
        ...
        $(closeIcon).addClass('outline outline-close close');
    ...
    _createClass(Range, [{
      ...
      value: function _handleRangeChange() {
        ...
        if (_documentDirectionName === "left") {
          ...
          var offseRight = this._calcRangeOffset();
          $(this.thumb).addClass('active').css('right', (offseRight - 7) + 'px');
        }
      }
      ...
      value: function _handleRangeMousedownTouchstart(e) {
        ...
        if (e.type !== 'input') {
          if (_documentDirectionName === "left") {
            ...
            var offsetRight = this._calcRangeOffset();
            $(this.thumb).addClass('active').css('right', (offsetRight - 7) + 'px');
          }
        }
      }
