...
anim(animOptions);}},{key:"_animateImageOut",value:function _animateImageOut(){var _this18=this;var animOptions={targets:this.el,width:this.originalWidth,height:this.originalHeight,top:0,duration:this.options.outDuration,easing:'easeOutQuad',complete:function(){_this18.placeholder.css({height:'',width:'',position:'',top:'',left:''});if(_this18.attrWidth){_this18.$el.attr('width',_this18.attrWidth);}
...
if(typeof _this18.options.onCloseEnd==='function'){_this18.options.onCloseEnd.call(_this18,_this18.el);}}};if(_documentDirectionName==='left'){animOptions.left=0;}else if(_documentDirectionName==='right'){animOptions.right=0;}
anim(animOptions);}},{key:"_updateVars",value:function _updateVars(){this.windowWidth=window.innerWidth;this.windowHeight=window.innerHeight;this.caption=this.el.getAttribute('data-caption')||'';}},{key:"open",value:function open(){var _this19=this;this._updateVars();this.originalWidth=this.el.getBoundingClientRect().width;this.originalHeight=this.el.getBoundingClientRect().height;this.doneAnimating=false;this.$el.addClass('active');this.overlayActive=true;if(typeof this.options.onOpenStart==='function'){this.options.onOpenStart.call(this,this.el);}
...
if(_documentDirectionName==="left"){var offsetLeft=this._calcRangeOffset();$(this.thumb).addClass('active').css('left',offsetLeft+'px');}else if(_documentDirectionName==="right"){var offseRight=this._calcRangeOffset();$(this.thumb).addClass('active').css('right',(offseRight-7)+'px');}}},{key:"_handleRangeMousedownTouchstart",value:function _handleRangeMousedownTouchstart(e){$(this.value).html(this.$el.val());this._mousedown=true;this.$el.addClass('active');if(!$(this.thumb).hasClass('active')){this._showRangeBubble();}
if(e.type!=='input'){if(_documentDirectionName==="left"){var offsetLeft=this._calcRangeOffset();$(this.thumb).addClass('active').css('left',offsetLeft+'px');}else if(_documentDirectionName==="right"){var offsetRight=this._calcRangeOffset();$(this.thumb).addClass('active').css('right',(offsetRight-7)+'px');}}}},{key:"_handleRangeInputMousemoveTouchmove",value:function _handleRangeInputMousemoveTouchmove(){if(this._mousedown){if(!$(this.thumb).hasClass('active')){this._showRangeBubble();}
if(_documentDirectionName==="left"){var offsetLeft=this._calcRangeOffset();$(this.thumb).addClass('active').css('left',offsetLeft+'px');}else if(_documentDirectionName==="right"){var offsetRight=this._calcRangeOffset();$(this.thumb).addClass('active').css('right',(offsetRight-7)+'px');console.log(offsetRight);}
